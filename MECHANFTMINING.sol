...
contract MECHANFTMINING {
	...
	constructor(address payable wallet, address payable _developer) public {
        ...
        plans.push(Plan(20, 90)); // SL Mecha (unlock)
        plans.push(Plan(20, 80)); // L Mecha (unlock)
        plans.push(Plan(20, 75)); // SR Mecha (unlock)
		plans.push(Plan(20, 70)); // R Mecha (locked)
        plans.push(Plan(20, 70)); // COMM Mecha (locked)
        plans.push(Plan(20, 70)); // UNC Mecha (locked)
	}
